...
public class FileDisplay extends javax.swing.JFrame {
    ...
    ArrayList<String> displayFile;
    public FileDisplay(ArrayList<String> textFile) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
